...
<!-- End Google Tag Manager -->
    ...
    <title>PHPTRAVELS | Travel Technology Partner</title>
    <!-- facebook -->
    <meta property="og:title" content="PHPTRAVELS | Travel Technology Partner"/>
...
<div class="demo" style="height: 60px; background: #2B2B2B; position: relative; width: 100%; z-index: 9999;">
<div>
<div style="padding:10px">
<div style"float:left;" class="animated fadeIn" style="animation-delay: 2s;">
<a href="https://phptravels.com/">
<div class="imagelogo"></div>
</a>
</div>

<div class="animated flash d-none d-md-block" style="animation-delay: 5s;color: #dcdbe4; position: absolute; margin: 0 auto; width: 98%; text-align: center; top: 17px">
<p>Selenium, Bots, or any automated softwares are not allowed to test here!</p>
</div>

<div class="animated fadeIn" style="animation-delay: 2s;float:right">
<a href="https://phptravels.com/order" target="_blank" class="btn btn-primary animated flash">Buy Now</a>
</div>
</div>
</div>
</div>
          ...
          <div class="row align-items-center no-gutters">
            <div class="col-md-4 col-2 o2">
              <div class="header-logo go-right">
                <a href="https://www.phptravels.net/">
                 <img class="" src="https://www.phptravels.net/uploads/global/logo.png" alt="PHPTRAVELS | Travel Technology Partner" />
                </a>
              </div>
            </div>
              ...
              <div class="mini-menu">
               <ul>
                ...
                <div class="dropdown dropdown-language">
                  ...
                  <span class="image"><img src="https://www.phptravels.net/uploads/images/language/en.png" alt="image" /></span> English                  </a>
                  <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownLangauge">
                    <div class="dropdown-menu-inner">
                      ...
                      <img class="go-right flafFIX" src="" width="21" height="14" alt="English">
                      </span>
                      </a>-->
                                            <a id="vi" class="dropdown-item" href="https://www.phptravels.net/vi"><span class="image"><img src="https://www.phptravels.net/uploads/images/language/vi.png" alt="image" /></span> Vietnamese</a>
                                            <a id="ru" class="dropdown-item" href="https://www.phptravels.net/ru"><span class="image"><img src="https://www.phptravels.net/uploads/images/language/ru.png" alt="image" /></span> Russian</a>
                                            <a id="en" class="dropdown-item" href="https://www.phptravels.net/en"><span class="image"><img src="https://www.phptravels.net/uploads/images/language/en.png" alt="image" /></span> English</a>
                                            <a id="ar" class="dropdown-item" href="https://www.phptravels.net/ar"><span class="image"><img src="https://www.phptravels.net/uploads/images/language/ar.png" alt="image" /></span> Arabic</a>
                                            <a id="fa" class="dropdown-item" href="https://www.phptravels.net/fa"><span class="image"><img src="https://www.phptravels.net/uploads/images/language/fa.png" alt="image" /></span> Farsi</a>
                                            <a id="tr" class="dropdown-item" href="https://www.phptravels.net/tr"><span class="image"><img src="https://www.phptravels.net/uploads/images/language/tr.png" alt="image" /></span> Turkish</a>
                                            <a id="fr" class="dropdown-item" href="https://www.phptravels.net/fr"><span class="image"><img src="https://www.phptravels.net/uploads/images/language/fr.png" alt="image" /></span> French</a>
                                            <a id="es" class="dropdown-item" href="https://www.phptravels.net/es"><span class="image"><img src="https://www.phptravels.net/uploads/images/language/es.png" alt="image" /></span> Spanish</a>
                                            <a id="de" class="dropdown-item" href="https://www.phptravels.net/de"><span class="image"><img src="https://www.phptravels.net/uploads/images/language/de.png" alt="image" /></span> German</a>
                                          </div>
                  </div>
                                                    </div>
                </li>
                ...
                <div class="dropdown dropdown-login dropdown-tab">
                  ...
                  <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownCurrency">
                    <div class="">
                      <a class="dropdown-item active tr" href="https://www.phptravels.net/login">Login</a>
                      <a class="dropdown-item tr" href="https://www.phptravels.net/register">Sign Up</a>
                    </div>
                  </div>
                </div>
                </li>
          ...
          <div class="navbar-wrapper">
            <div class="navbar navbar-expand-lg">
              <div id="mobileMenuMain" class="collapse navbar-collapse o2 fe">
                ...
                <ul class="main-nav">
                <li><a href="https://www.phptravels.net/" title="home">Home</a></li>
                </ul>
                                    <ul class="main-nav">
                                            <li><a href="https://www.phptravels.net/m-visa      " target=""
                               title="">Visa      </a></li>
                                                <li class="text-center">
                            <a>company</a>
                            <ul style="display: none;">
                                                                <li><a href="https://www.phptravels.net/contact-us" target=""
                                       title="">Contact</a></li>
                                                                <li><a href="https://www.phptravels.net/About-Us" target=""
                                       title="">About Us</a></li>
                                                            </ul>
                        </li>
...
<div class="slick-hero-slider-wrapper bg-light">
    <div class="slider slick-hero-slider slick-slider-center-mode slick-animation mb-0">
                    ...
                    <div class="bg-image active" data-dark-overlay="3" style="background-image:url('https://www.phptravels.net/uploads/images/slider/e41yislk0084kkg.jpg');">
                        <div class="caption-outer">
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="hero-text tr d-none d-md-block">
                                                <h2 class="animation fromBottom transitionDelay2 transitionDuration4">Your journey begins here</h2>
                                                <p class="animation fromBottom transitionDelay4 transitionDuration6 lead">Search over 450 airlines and more than 320,000 hotels around the world.</p>
                                                <div class="clear"></div>
                            ...
                            <div class="slick-item">
                    <div class="bg-image " data-dark-overlay="3" style="background-image:url('https://www.phptravels.net/uploads/images/slider/76ejktjn6y88ckk.jpg');">
                        <div class="caption-outer">
                            <div class="container-fluid">
                                <div class="caption-inner">
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="hero-text tr d-none d-md-block">
                                                <h2 class="animation fromBottom transitionDelay2 transitionDuration4">Vacation Packages</h2>
                                                <p class="animation fromBottom transitionDelay4 transitionDuration6 lead">Find out the best deals and book yours today</p>
                                                <div class="clear"></div>
                                                <!--<p class="animation fromBottom transitionDelay6 transitionDuration8 hero-price d-block">
                                                 all starting from <span>USD $986</span>
                                                </p>
                            ...
                            <div class="slick-item">
                    <div class="bg-image " data-dark-overlay="3" style="background-image:url('https://www.phptravels.net/uploads/images/slider/f4n79teyk0g8kg8.jpg');">
                        <div class="caption-outer">
                            <div class="container-fluid">
                                <div class="caption-inner">
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="hero-text tr d-none d-md-block">
                                                <h2 class="animation fromBottom transitionDelay2 transitionDuration4">Travel to the World</h2>
                                                <p class="animation fromBottom transitionDelay4 transitionDuration6 lead">Discover the hidden beauty from top to bottom</p>
                                                <div class="clear"></div>
                                                <!--<p class="animation fromBottom transitionDelay6 transitionDuration8 hero-price d-block">
                                                 all starting from <span>USD $986</span>
                                                </p>
            ...
            <div class="slick-item">
            <div class="bg-image " data-dark-overlay="4"
                 style="background-image:url('https://www.phptravels.net/themes/default/assets/img/data/slider.jpg');">
            </div>
        </div>
                    ...
                    <div class="hero-form-inner text-white">
                        <div class="menu-horizontal-wrapper-02">
                            <nav class="menu-horizontal-02">
                                <ul class="nav row-reverse ">
                                        <li>
        <a class="text-center hotels active" data-name="hotels"  href="#hotels" target="" data-toggle="tab">
         Hotels        </a>
    </li>
    <li>
        <a class="text-center flights " data-name="flights"  href="#flights" target="" data-toggle="tab">
         Flights        </a>
    </li>
    <li>
        <a class="text-center tours " data-name="tours"  href="#tours" target="" data-toggle="tab">
         Tours        </a>
    </li>
    <li>
        <a class="text-center cars " data-name="cars"  href="#cars" target="" data-toggle="tab">
         Cars        </a>
    </li>
    <li>
        <a class="text-center visa " data-name="visa"  href="#visa" target="" data-toggle="tab">
         Visa        </a>
    </li>
<!--
    <li role="presentation" name="Hotels" class="active text-center">
                                                <a class="" href="#hotels" data-toggle="tab" aria-controls="home" aria-expanded="true" title="Hotels">
                    <div class="visible-xs visible-md clearfix"></div>
                    <span class="hidden-xs">Hotels    </span>
                </a>
                        </li>
    <li role="presentation" name="Flights" class=" text-center">
                                                <a class="" href="#flights" data-toggle="tab" aria-controls="home" aria-expanded="true" title="Flights">
                    <div class="visible-xs visible-md clearfix"></div>
                    <span class="hidden-xs">Flights   </span>
                </a>
                        </li>
    <li role="presentation" name="Viator" class=" text-center">
                                                <a class="" href="#viator" data-toggle="tab" aria-controls="home" aria-expanded="true" title="Viator">
                    <div class="visible-xs visible-md clearfix"></div>
                    <span class="hidden-xs">Tours  </span>
                </a>
                        </li>
    <li role="presentation" name="Cartrawler" class=" text-center">
                                                <a class="" href="#car" data-toggle="tab" aria-controls="home" aria-expanded="true" title="Cars">
                    <div class="visible-xs visible-md clearfix"></div>
                    <span class="hidden-xs">Cars      </span>
                </a>
                        </li>
    <li role="presentation" name="Ivisa" class=" text-center">
                                                <a class="" href="#ivisa" data-toggle="tab" aria-controls="home" aria-expanded="true" title="Visa">
                    <div class="visible-xs visible-md clearfix"></div>
...
<form name="HOTELS" autocomplete="off" action="https://www.phptravels.net/hotels/search" method="GET" role="search">
            ...
            <div class="col-md-3 col-xs-12">
                <div class="form-group">
                    ...
                    <div class="form-icon-left typeahead__container">
                        ...
                        <input class="form-control hotelsearch locationlistHotels" name="dest" type="search" autocomplete="off" value="" required>
                    </div>
                </div>
            </div>
                    ...
                    <div id="airDatepickerRange-hotel" class="row no-gutters mb-15">
                        <div class="col-md-6 o2">
                            <div class="form-group">
                                ...
                                <div class="form-icon-left">
                                    ...
                                    <input type="text" id="checkin" class="form-control form-readonly-control" name="checkin" placeholder="04/07/2020" required value="04/07/2020">
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6 o1">
                            <div class="form-group">
                                ...
                                <div class="form-icon-left">
                                    <span class="icon-font text-muted"><i class="bx bx-calendar"></i></span>
                                    <input type="text" id="checkout" class="form-control form-readonly-control" name="checkout" placeholder="05/07/2020" required value="05/07/2020">
                                </div>
                            </div>
                        </div>
                    </div>
...
return {results: JSON.parse('[{"text":"Hotels","children":[{"id":"istanbul\/alzer-hotel-istanbul","text":"Alzer Hotel Istanbul, Istanbul","module":"hotel","disabled":false},{"id":"istanbul\/tria-hotel-istanbul-special","text":"Tria Hotel Istanbul Especial, Istanbul","module":"hotel","disabled":false},{"id":"london\/grand-plaza-apartments","text":"Grand Plaza Serviced Apartments, London","module":"hotel","disabled":false},{"id":"madinah\/madinah-moevenpick-hotel","text":"Madinah Moevenpick Hotel, Madinah","module":"hotel","disabled":false},{"id":"dubai\/jumeirah-beach-hotel","text":"Jumeirah Beach Hotel, Dubai","module":"hotel","disabled":false},{"id":"dubai\/oasis-beach-tower","text":"Oasis Beach Tower, Dubai","module":"hotel","disabled":false},{"id":"manchester\/malmaison-manchester","text":"Malmaison Manchester, Manchester","module":"hotel","disabled":false},{"id":"dubai\/rose-rayhaan-rotana","text":"Rose Rayhaan Rotana, Dubai","module":"hotel","disabled":false},{"id":"islamabad\/islamabad-marriott-hotel","text":"Islamabad Marriott Hotel, Islamabad","module":"hotel","disabled":false},{"id":"dubai\/hyatt-regency-perth","text":"Hyatt Regency Perth, Dubai","module":"hotel","disabled":false},{"id":"messe-basel\/swissotel-le-plaza-basel","text":"Swissotel Le Plaza Basel, Messe Basel","module":"hotel","disabled":false},{"id":"singapore\/rendezvous-hotels","text":"\u00d6deme Se\u00e7enekleri , Singapore","module":"hotel","disabled":false}]},{"text":"Locations","children":[{"id":"turkey\/istanbul","text":"Istanbul, Turkey","module":"location","disabled":false},{"id":"united-kingdom\/london","text":"London, United Kingdom","module":"location","disabled":false},{"id":"saudi-arabia\/madinah","text":"Madinah, Saudi Arabia","module":"location","disabled":false},{"id":"united-arab-emirates\/dubai","text":"Dubai, United Arab Emirates","module":"location","disabled":false},{"id":"united-kingdom\/manchester","text":"Manchester, United Kingdom","module":"location","disabled":false},{"id":"pakistan\/islamabad","text":"Islamabad, Pakistan","module":"location","disabled":false},{"id":"switzerland\/messe-basel","text":"Messe Basel, Switzerland","module":"location","disabled":false},{"id":"singapore\/singapore","text":"Singapore, Singapore","module":"location","disabled":false}]}]')}
}
}
},
...
<div class="tab-inner menu-horizontal-content">
    <div class="form-search-main-01">
        <form autocomplete="off" name="flightmanualSearch" action="https://www.phptravels.net/flights/search/" method="GET" role="search">
            <div class="form-inner">
                <div class="row  mb-10 row-reverse align-items-start row-return">
                    ...
                    <div class="row row-reverse" style="margin-top:4px">
                            ...
                            <input type="radio" id="flightSearchRadio-2" name="triptype" class="custom-control-input oneway"  value="oneway"  checked >
                            <label class="custom-control-label" for="flightSearchRadio-2">One Way</label>
                        </div>
                                                <div class="custom-control custom-radio  custom-control-inline" style="margin-top: -5px;">
                            <input type="radio" id="flightSearchRadio-1" name="triptype" class="custom-control-input return"  value="round" >
                            <label class="custom-control-label" for="flightSearchRadio-1">Round Trip</label>
                        ...
                        <div class="row no-gutters">
                            <div class="col-md-6 col-6">
                                <div class="form-group">
                                    ...
                                    <div class="form-icon-left typeahead__container">
                                        <span class="icon-font text-muted"><i class="bx bx-map"></i></span>
                                        <input class="form-control" type="text" name="" value="LHE" id="location_from" type="search" autocomplete="off">
                                        <input type="hidden" name="origin" value="LHE" id="location_from_code">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6 col-6">
                                <div class="form-group">
                                    ...
                                    <div class="form-icon-left typeahead__container">
                                        <span class="icon-font text-muted"><i class="bx bx-map"></i></span>
                                        <input type="text" name="" value="DXB" id="location_to" class="form-control" type="search" autocomplete="off">
                                        <input type="hidden" name="destination" value="DXB" id="location_to_code">
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div id="airDatepickerRange-flight" class="row no-gutters mb-15">
                                <div class="class12 col-6">
                                    <div class="form-group">
                                        ...
                                        <div class="form-icon-left">
                                            <span class="icon-font text-muted"><i class="bx bx-calendar"></i></span>
                                            <input id="FlightsDateStart" class="form-control form-readonly-control" placeholder="Depart" name="departure_date" value="" readonly>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-icon-left">
                                            <span class="icon-font text-muted"><i class="bx bx-calendar"></i></span>
                                            <input id="FlightsDateEnd" autocomplete="false" class="form-control form-readonly-control" placeholder="Return" name="reture_date" value="" readonly>
                                        </div>
                                    </div>
                                </div>
                                                            </div>
                    ...
                    <div class="col-md-4 col-xs-12">
                        <div class="col-inner">
                            <div class="row no-gutters">
                                                                <div class="col-4">
                                    <div class="form-group form-spin-group">
                                        <label for="room-amount">Adults <small class="text-muted font10 line-1" hidden>(12-75)</small></label>
                                        <div class="clear"></div>
                                        <div class="form-icon-left">
                                            <span class="icon-font text-muted"><i class="bx bx-user"></i></span>
                                            <input type="text" class="form-control touch-spin-03 form-readonly-control" placeholder="0" readonly name="fadults" value="1"/>
                                        </div>
                                    </div>
                                </div>
                                                                <div class="col-4">
                                    <div class="form-group form-spin-group">
                                        <label for="room-amount">Child <small class="text-muted font10 line-1" hidden>(2-12)</small></label>
                                        <div class="clear"></div>
                                        <div class="form-icon-left">
                                            <span class="icon-font text-muted"><i class="bx bx-user"></i></span>
                                            <input type="text" class="form-control touch-spin-03 form-readonly-control" placeholder="0" readonly name="fchildren" value="0"/>
                                        </div>
                                    </div>
                                </div>
                                                                <div class="col-4">
                                    <div class="form-group form-spin-group">
                                        <label for="room-amount">infant <small class="text-muted font10 line-1" hidden>(0-2)</small></label>
                                        <div class="clear"></div>
                                        <div class="form-icon-left">
                                            <span class="icon-font text-muted"><i class="bx bx-user"></i></span>
                                            <input type="text" class="form-control touch-spin-03 form-readonly-control" placeholder="0" name="finfant" readonly value="0"/>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<script type="text/javascript">
    ...
    $(".return").click(function() {
        ...
        $(".class12").removeClass('col-12');
                                                                            ...
                                                                            <!-- Tours  -->
                                        <div role="tabpanel" class="tab-pane " id="tours" aria-labelledby="home-tab">
                                                                                        <style>
    .form-control{
        overflow:hidden;
        -webkit-appearance:none;
...
<div class="ftab-inner menu-horizontal-content">
    <div class="form-search-main-01 tour-search">
        <form autocomplete="off" action="https://www.phptravels.net/packages/search" method="get" role="search">
            <div class="form-inner">
                <div class="row gap-10 mb-15 align-items-end row-reverse">
                    <div class="col-md-3 col-xs-12">
                        <div class="form-group">
                                        ...
                                        <div class="form-people-thread">
                                            <div class="row gap-5 align-items-center">
                                                <div id="airDatepickerRange-hotel" class="col">
                                                    <div class="form-group form-spin-group">
                                                        <label for="room-amount" class="text-left">From Date</label>
                                                        <div class="clear"></div>
                                                        <div class="form-icon-left">
                                                            <span class="icon-font text-muted" style="margin-left:12px"><i class="bx bx-calendar"></i></span>
                                                            <input type="text" id="DateTours" class="DateTours form-control form-readonly-control" placeholder="dd/mm/yyyy" value="" name="startDate" required>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="col-inner">
                                        <div class="form-people-thread">
                                            <div class="row gap-5 align-items-center">
                                                <div id="airDatepickerRange-hotel" class="col">
                                                    <div class="form-group form-spin-group">
                                                        <label for="room-amount" class="text-left" style="">To Date</label>
                                                        <div class="clear"></div>
                                                        <div class="form-icon-left">
                                                            <span class="icon-font text-muted" style="margin-left:12px"><i class="bx bx-calendar"></i></span>
                                                            <input type="text" id="EndDateTours" class="DateTours form-control form-readonly-control" placeholder="dd/mm/yyyy" value="" name="endDate" required>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                    ...
                    <div class="col-md-3 col-xs-12">
                        ...
                        <button type="submit"  class="btn btn-primary btn-block"><i class="icon_set_1_icon-66"></i> Search</button>
                    </div>
                </div>
            </div>
            ...
            <script>
                ...
                $(function () {
                    $(".viatorsearch").select2({
                        ...
                        initSelection: function (element, callback) {
                            callback({id: "", text: 'Search by City Name'})
                        }
                    });
...
<!------------------------------------------------------------------->
                                                                            ...
                                                                            <!-- Cars  -->
                                        <div role="tabpanel" class="tab-pane " id="cars" aria-labelledby="home-tab">
                                                                                        <div class="tab-inner menu-horizontal-content">
  <div class="form-search-main-01">
   <form action="https://www.phptravels.net/car/" method="GET" target="_self" autocomplete="off">
      <div class="form-inner">
        <div class="row gap-10 mb-15">
          <div class="col-md-2 col-xs-12">
            <div class="form-group">
              ...
              <div class="form-icon-left">
                <span class="icon-font text-muted"><i class="bx bx-map"></i></span>
                 <input  class='form-control form-readonly-control car-startlocation' name="startlocation" type='text' placeholder="Pick up" />
              </div>
            </div>
          </div>
          <div class="col-md-2 col-xs-12">
            <div class="form-group">
              ...
              <div class="form-icon-left ">
                <span class="icon-font text-muted"><i class="bx bx-map"></i></span>
                <input class='form-control form-readonly-control car-endlocation' name="endlocation" type='text' placeholder="Drop off" />
              </div>
            </div>
          </div>
          <div class="col-md-3 col-xs-12">
              ...
              <div id="airDatepickerRange-flight" class="row no-gutters mb-15">
                <div class="col-6">
                  <div class="form-group">
                    ...
                    <div class="form-icon-left">
                      <span class="icon-font text-muted"><i class="bx bx-calendar"></i></span>
                      <input placeholder="dd/mm/yyyy" autocomplete="false" class="form-control form-readonly-control checkinsearch CarTrawlerStart" placeholder="Depart" name="pickupdate" value="01/07/2020" required>
                    </div>
                  </div>
                </div>
                <div class="col-6">
              ...
              <div id="airDatepickerRange-flight" class="row no-gutters mb-15">
                <div class="col-6">
                  <div class="form-group">
                    ...
                    <div class="form-icon-left">
                      <span class="icon-font text-muted"><i class="bx bx-calendar"></i></span>
                      <input placeholder="dd/mm/yyyy" autocomplete="false" class="form-control form-readonly-control checkinsearch CarTrawlerEnd" placeholder="Depart" name="dropoffdate" value="02/07/2020" required>
                    </div>
                  </div>
                </div>
                <div class="col-6">
        ...
        <input type="hidden" name="clientId" value="741882">
        <input type="hidden" name="residencyId" value="US">
          ...
          Search          </button>
                                        ...
                                        <div role="tabpanel" class="tab-pane " id="visa" aria-labelledby="home-tab">
                                            <div class="tab-inner menu-horizontal-content">
    <div class="form-search-main-01">
        <form autocomplete="off" action="https://www.phptravels.net/visa" method="GET" role="search">
            <div class="form-inner">
                <div class="row gap-10 mb-15 align-items-center row-reverse">
                    ...
                    <div class="col-md-2 col-xs-12">
                        <div class="form-group">
                            <label>Date<span class="font12 text-danger">*</span></label>
                            <div class="clear"></div>
                            <div class="form-icon-left">
                                <span class="icon-font text-muted"><i class="bx bx-calendar"></i></span>
                                <input type="search" id="" required="" name="date" placeholder="Date" class="visadate form-control form-bg-light">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-2 col-xs-12">
...
</script><div class="mt-30 mb-40">
<div class="container-fluid">
<div class="section-title">
<h2 class="float-none">Latest on blogs</h2>
</div>
<div class="tab-content">
    ...
    <div class="tab-inner">
        <div class="row equal-height cols-1 cols-sm-2 cols-lg-3 gap-10 gap-md-20 gap-xl-30">
                ...
                <div class="product-grid-item">
                    <a href="https://www.phptravels.net/blog/Virgin-Gorda-beaches-and-lobste">
                        <div class="image" style="overflow:hidden;height:150px">
                            <img src="https://www.phptravels.net/uploads/images/blog/780975_1.jpg" alt="Image">
                        </div>
                        <div class="content clearfix">
                            <div class="">
                                <h5 class="float-none">Virgin Gorda beaches and&#8230;</h5>
                                <p class="location"><i class="fas fa-map-marker-alt text-primary"></i> This is the second leg of a truly fun week. There are adventures&#8230;</p>
                            </div>
                        </div>
                    </a>
                </div>
                       ...
                       <div class="col">
                <div class="product-grid-item">
                    <a href="https://www.phptravels.net/blog/Fiercely-Independent-Cultures">
                        <div class="image" style="overflow:hidden;height:150px">
                            <img src="https://www.phptravels.net/uploads/images/blog/696228_2.jpg" alt="Image">
                        </div>
                        <div class="content clearfix">
                            <div class="">
                                <h5 class="float-none">Fiercely Independent Cultures</h5>
                                <p class="location"><i class="fas fa-map-marker-alt text-primary"></i> In a world that is increasingly homogenous, fiercely independent&#8230;</p>
                            </div>
                        </div>
                    </a>
                </div>
                       ...
                       <div class="col">
                <div class="product-grid-item">
                    <a href="https://www.phptravels.net/blog/Peace-Train-A-Long-Time-Coming">
                        <div class="image" style="overflow:hidden;height:150px">
                            <img src="https://www.phptravels.net/uploads/images/blog/120331_3.jpg" alt="Image">
                        </div>
                        <div class="content clearfix">
                            <div class="">
                                <h5 class="float-none">Peace Train A Long Time Coming</h5>
                                <p class="location"><i class="fas fa-map-marker-alt text-primary"></i> &nbsp;mainland Europe and North America, Iceland has always&#8230;</p>
                            </div>
                        </div>
                    </a>
                </div>
...
<div class="mb-40">
<div class="section-title">
<h2 class="float-none">Featured Hotels</h2>
<div class="clear"></div>
</div>
<div role="tabpanel" class="tab-pane active" id="MenuHorizon28_01">
<div class="tab-inner">
...
<div class="col-3">
<div class="product-grid-item">
    <a href="https://www.phptravels.net/hotels/singapore/singapore/Rendezvous-Hotels">
        <span class="discount">5 % Discount</span>        <div class="image">
            <img src="https://www.phptravels.net/uploads/images/hotels/slider/thumbs/75043_1.jpg" alt="Image">
        </div>
        <div class="content clearfix">
            <div class="rating-item rating-sm go-text-right">
                <div class="rating-icons">
                    <i class='rating-icon fa fa-star rating-rated'></i><i class='rating-icon fa fa-star rating-rated'></i><i class='rating-symbol-background rating-icon far fa-star'></i><i class='rating-symbol-background rating-icon far fa-star'></i><i class='rating-symbol-background rating-icon far fa-star'></i>                </div>
            ...
            <div class="short-info go-right">
                <h5 class="float-none">Rendezvous Hotels</h5>
                <div class="clear"></div>
                <p class="location go-text-right"><i class="fas fa-map-marker-alt text-primary go-right"></i> Singapore</p>
            </div>
            <div class="clear"></div>
                        <div class="price">
                <div class="">
                    Book Now                    <span class="text-secondary"><!--USD--> $85</span>
                    Per Night                </div>
            </div>
                    </div>
    </a>
...
<div class="col-3">
<div class="product-grid-item">
    <a href="https://www.phptravels.net/hotels/switzerland/messe-basel/Swissotel-Le-Plaza-Basel">
        <span class="discount">15 % Discount</span>        <div class="image">
            <img src="https://www.phptravels.net/uploads/images/hotels/slider/thumbs/588989_2.jpg" alt="Image">
        </div>
        <div class="content clearfix">
            <div class="rating-item rating-sm go-text-right">
                <div class="rating-icons">
            ...
            <div class="short-info go-right">
                <h5 class="float-none">Swissotel Le Plaza Basel</h5>
                <div class="clear"></div>
                <p class="location go-text-right"><i class="fas fa-map-marker-alt text-primary go-right"></i> Messe Basel</p>
            </div>
            <div class="clear"></div>
                        <div class="price">
                <div class="">
                    Book Now                    <span class="text-secondary"><!--USD--> $80</span>
                    Per Night                </div>
            </div>
                    </div>
    </a>
...
<div class="col-3">
<div class="product-grid-item">
    <a href="https://www.phptravels.net/hotels/united-arab-emirates/dubai/Hyatt-Regency-Perth">
                <div class="image">
            <img src="https://www.phptravels.net/uploads/images/hotels/slider/thumbs/637176_3.jpg" alt="Image">
        </div>
        <div class="content clearfix">
            <div class="rating-item rating-sm go-text-right">
                <div class="rating-icons">
            ...
            <div class="short-info go-right">
                <h5 class="float-none">Hyatt Regency Perth</h5>
                <div class="clear"></div>
                <p class="location go-text-right"><i class="fas fa-map-marker-alt text-primary go-right"></i> Dubai</p>
            </div>
            <div class="clear"></div>
                        <div class="price">
                <div class="">
                    Book Now                    <span class="text-secondary"><!--USD--> $150</span>
                    Per Night                </div>
            </div>
                    </div>
    </a>
...
<div class="col-3">
<div class="product-grid-item">
    <a href="https://www.phptravels.net/hotels/pakistan/islamabad/Islamabad-Marriott-Hotel">
        <span class="discount">15 % Discount</span>        <div class="image">
            <img src="https://www.phptravels.net/uploads/images/hotels/slider/thumbs/94178_4.jpg" alt="Image">
        </div>
        <div class="content clearfix">
            <div class="rating-item rating-sm go-text-right">
                <div class="rating-icons">
                    <i class='rating-icon fa fa-star rating-rated'></i><i class='rating-icon fa fa-star rating-rated'></i><i class='rating-icon fa fa-star rating-rated'></i><i class='rating-icon fa fa-star rating-rated'></i><i class='rating-icon fa fa-star rating-rated'></i>                </div>
                <!--<p class="rating-text text-muted"><span class="bg-primary">6.0</span> <strong class="text-dark">Good</strong> - 1,2547 reviews</p>-->
            </div>
            <div class="short-info go-right">
                <h5 class="float-none">Islamabad Marriott Hotel</h5>
                <div class="clear"></div>
                <p class="location go-text-right"><i class="fas fa-map-marker-alt text-primary go-right"></i> Islamabad</p>
            </div>
            <div class="clear"></div>
                        <div class="price">
                <div class="">
                    Book Now                    <span class="text-secondary"><!--USD--> $100</span>
                    Per Night                </div>
            </div>
                    </div>
    </a>
...
<div class="col-3">
<div class="product-grid-item">
    <a href="https://www.phptravels.net/hotels/united-arab-emirates/dubai/Rose-Rayhaan-Rotana">
                <div class="image">
            <img src="https://www.phptravels.net/uploads/images/hotels/slider/thumbs/596771_5.jpg" alt="Image">
        </div>
        <div class="content clearfix">
            <div class="rating-item rating-sm go-text-right">
                <div class="rating-icons">
            ...
            <div class="short-info go-right">
                <h5 class="float-none">Rose Rayhaan Rotana</h5>
                <div class="clear"></div>
                <p class="location go-text-right"><i class="fas fa-map-marker-alt text-primary go-right"></i> Dubai</p>
            </div>
            <div class="clear"></div>
...
<div class="col-3">
<div class="product-grid-item">
    <a href="https://www.phptravels.net/hotels/united-kingdom/manchester/Malmaison-Manchester">
        <span class="discount">10 % Discount</span>        <div class="image">
            <img src="https://www.phptravels.net/uploads/images/hotels/slider/thumbs/100617_6.jpg" alt="Image">
        </div>
        <div class="content clearfix">
            <div class="rating-item rating-sm go-text-right">
                <div class="rating-icons">
            ...
            <div class="short-info go-right">
                <h5 class="float-none">Malmaison Manchester</h5>
                <div class="clear"></div>
                <p class="location go-text-right"><i class="fas fa-map-marker-alt text-primary go-right"></i> Manchester</p>
            </div>
            <div class="clear"></div>
                        <div class="price">
                <div class="">
                    Book Now                    <span class="text-secondary"><!--USD--> $20</span>
                    Per Night                </div>
            </div>
                    </div>
    </a>
...
<div class="mb-80"></div>
<div class="section-title">
<h2 class="float-none">Featured Flights</h2>
<div class="clear"></div>
</div>
<div class="mb-40">
<div class="row cols-2 cols-md-3 cols-lg-4 gap-10 gap-md-20">
        ...
        <figure class="image-caption-01">
            <a href="javascript:void(0)">
                <div class="image overlay-relative caption-relative">
                    <img style="max-height:75px;padding:15px" src="https://www.phptravels.net/uploads/images/flights/slider/175znubux0pw4gw.png" alt="image">
                    ...
                    <figcaption class="caption-holder">
                        <div class="caption-inner caption-middle text-center">
                            <h5 class="float-none">Srilanka Airways</h5>
                            <span class="d-block">USD 780</span>
                        </div>
                    </figcaption>
                </div>
            </a>
    ...
    <div class="col-6 col-lg-3">
        <figure class="image-caption-01">
            <a href="javascript:void(0)">
                <div class="image overlay-relative caption-relative">
                    <img style="max-height:75px;padding:15px" src="https://www.phptravels.net/uploads/images/flights/slider/b47cgm5h3tc8sw0.png" alt="image">
                    <div class="overlay-holder opacity-2" style="opacity:0.8"></div>
                    <figcaption class="caption-holder">
                        <div class="caption-inner caption-middle text-center">
                            <h5 class="float-none">Air Phillpines</h5>
                            <span class="d-block">USD 450</span>
                        </div>
                    </figcaption>
                </div>
            </a>
    ...
    <div class="col-6 col-lg-3">
        <figure class="image-caption-01">
            <a href="javascript:void(0)">
                <div class="image overlay-relative caption-relative">
                    <img style="max-height:75px;padding:15px" src="https://www.phptravels.net/uploads/images/flights/slider/91raniksw5wc404.png" alt="image">
                    <div class="overlay-holder opacity-2" style="opacity:0.8"></div>
                    <figcaption class="caption-holder">
                        <div class="caption-inner caption-middle text-center">
                            <h5 class="float-none">Gulf Air</h5>
                            <span class="d-block">USD 650</span>
                        </div>
                    </figcaption>
                </div>
            </a>
    ...
    <div class="col-6 col-lg-3">
        <figure class="image-caption-01">
            <a href="javascript:void(0)">
                <div class="image overlay-relative caption-relative">
                    <img style="max-height:75px;padding:15px" src="https://www.phptravels.net/uploads/images/flights/slider/9nl4tj6jspgco00.png" alt="image">
                    <div class="overlay-holder opacity-2" style="opacity:0.8"></div>
                    <figcaption class="caption-holder">
                        <div class="caption-inner caption-middle text-center">
                            <h5 class="float-none">Etihad Airways</h5>
                            <span class="d-block">USD 800</span>
                        </div>
                    </figcaption>
                </div>
            </a>
    ...
    <div class="col-6 col-lg-3">
        <figure class="image-caption-01">
            <a href="javascript:void(0)">
                <div class="image overlay-relative caption-relative">
                    <img style="max-height:75px;padding:15px" src="https://www.phptravels.net/uploads/images/flights/slider/rd28iqxqv808gk.png" alt="image">
                    <div class="overlay-holder opacity-2" style="opacity:0.8"></div>
                    <figcaption class="caption-holder">
                        <div class="caption-inner caption-middle text-center">
                            <h5 class="float-none">Canadian Airways</h5>
                            <span class="d-block">USD 860</span>
                        </div>
                    </figcaption>
                </div>
            </a>
    ...
    <div class="col-6 col-lg-3">
        <figure class="image-caption-01">
            <a href="javascript:void(0)">
                <div class="image overlay-relative caption-relative">
                    <img style="max-height:75px;padding:15px" src="https://www.phptravels.net/uploads/images/flights/slider/2qccdvq0wvy840c.png" alt="image">
                    <div class="overlay-holder opacity-2" style="opacity:0.8"></div>
                    <figcaption class="caption-holder">
                        <div class="caption-inner caption-middle text-center">
                            <h5 class="float-none">Turkish Airlines</h5>
                            <span class="d-block">USD 800</span>
                        </div>
                    </figcaption>
                </div>
    ...
    <div class="col-6 col-lg-3">
        <figure class="image-caption-01">
            <a href="javascript:void(0)">
                <div class="image overlay-relative caption-relative">
                    <img style="max-height:75px;padding:15px" src="https://www.phptravels.net/uploads/images/flights/slider/7lcw4cf8hwo480w.png" alt="image">
                    <div class="overlay-holder opacity-2" style="opacity:0.8"></div>
                    <figcaption class="caption-holder">
                        <div class="caption-inner caption-middle text-center">
                            <h5 class="float-none">Air India</h5>
                            <span class="d-block">USD 450</span>
                        </div>
                    </figcaption>
                </div>
    ...
    <div class="col-6 col-lg-3">
        <figure class="image-caption-01">
            <a href="javascript:void(0)">
                <div class="image overlay-relative caption-relative">
                    <img style="max-height:75px;padding:15px" src="https://www.phptravels.net/uploads/images/flights/slider/20tegedgl4yswgk.png" alt="image">
                    <div class="overlay-holder opacity-2" style="opacity:0.8"></div>
                    <figcaption class="caption-holder">
                        <div class="caption-inner caption-middle text-center">
                            <h5 class="float-none">Emirates Airlines</h5>
                            <span class="d-block">USD 900</span>
                        </div>
                    </figcaption>
                </div>
            </a>
    ...
    <div class="col-6 col-lg-3">
        <figure class="image-caption-01">
            <a href="javascript:void(0)">
                <div class="image overlay-relative caption-relative">
                    <img style="max-height:75px;padding:15px" src="https://www.phptravels.net/uploads/images/flights/slider/ae838q1tjrscs8k.png" alt="image">
                    <div class="overlay-holder opacity-2" style="opacity:0.8"></div>
                    <figcaption class="caption-holder">
                        <div class="caption-inner caption-middle text-center">
                            <h5 class="float-none">American Airlines</h5>
                            <span class="d-block">USD 1200</span>
                        </div>
                    </figcaption>
                </div>
            </a>
    ...
    <div class="col-6 col-lg-3">
        <figure class="image-caption-01">
            <a href="javascript:void(0)">
                <div class="image overlay-relative caption-relative">
                    <img style="max-height:75px;padding:15px" src="https://www.phptravels.net/uploads/images/flights/slider/ybaegc18zpc4ko.png" alt="image">
                    <div class="overlay-holder opacity-2" style="opacity:0.8"></div>
                    <figcaption class="caption-holder">
                        <div class="caption-inner caption-middle text-center">
                            <h5 class="float-none">Pakistan Airlines</h5>
                            <span class="d-block">USD 620</span>
                        </div>
                    </figcaption>
                </div>
            </a>
    ...
    <div class="col-6 col-lg-3">
        <figure class="image-caption-01">
            <a href="javascript:void(0)">
                <div class="image overlay-relative caption-relative">
                    <img style="max-height:75px;padding:15px" src="https://www.phptravels.net/uploads/images/flights/slider/1gmmwudrvzi888k.png" alt="image">
                    <div class="overlay-holder opacity-2" style="opacity:0.8"></div>
                    <figcaption class="caption-holder">
                        <div class="caption-inner caption-middle text-center">
                            <h5 class="float-none">Malaysia Airlines</h5>
                            <span class="d-block">USD 800</span>
                        </div>
                    </figcaption>
                </div>
    ...
    <div class="col-6 col-lg-3">
        <figure class="image-caption-01">
            <a href="javascript:void(0)">
                <div class="image overlay-relative caption-relative">
                    <img style="max-height:75px;padding:15px" src="https://www.phptravels.net/uploads/images/flights/slider/e2kkchakfxw80w8.png" alt="image">
                    <div class="overlay-holder opacity-2" style="opacity:0.8"></div>
                    <figcaption class="caption-holder">
                        <div class="caption-inner caption-middle text-center">
                            <h5 class="float-none">Qater Airlines</h5>
                            <span class="d-block">USD 750</span>
                        </div>
                    </figcaption>
                </div>
            </a>
...
<section class="pb-0">
    <div class="">
        <div class="section-title">
            <h2 class="float-none">Featured Offers    </h2>
        </div>
                            ...
                            <div class="row equal-height gap-0">
                                <div class="col-12 col-lg-8">
                                    <div class="image caption-relative">
                                        <img src="https://www.phptravels.net/uploads/images/offers/976745_save.jpg"alt="image"/>
                                        <div class="caption-holder padding-10">
                                            <div class="caption-top w-100 text-left">
                                                <span class="bg-secondary d-inline-block font600 text-uppercase font12 ph-15 pv-5 line-135 rounded">BIG Save</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-12 col-lg-4 col">
                                    <div class="content d-flex flex-column">
                                        ...
                                        <div class="content-bottom mt-auto">
                                            ...
                                            <a href="https://www.phptravels.net/offers" class="btn btn-primary btn-lg btn-wide mt-20 btn-block">View More</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<div class="container-fluid">
    <div class="row row-reverse">
        <div class="col-6 col-lg-3 d-flex align-items-center">
          <img class="img-responsive mt-auto" src="https://www.phptravels.net/themes/default/assets/img/mobile.png" class="img-responsive" alt="mobile apps" >
        </div>
        ...
        <div>
         <div class="mb-50 hidden-xs-down"></div>
            ...
            <ul class="theme-mobile-app-btn-list go-text-right">
                                <li>
                    <a target="blank" class="btn btn-dark theme-mobile-app-btn" href="https://itunes.apple.com/us/app/phptravels/id1018217005?mt=8">
                    <i class="theme-mobile-app-logo">
                    <img src="https://www.phptravels.net/themes/default/assets/img/apple.png" alt="Image Alternative text" title="Image Title">
                    </i>
                    <span>Download on
                    <br>
                    <span>App Store</span>
                                                ...
                                                <li>
                    <a target="blank" class="btn btn-dark theme-mobile-app-btn" href="https://play.google.com/store/apps/details?id=com.phptravelsnative">
                    <i class="theme-mobile-app-logo">
                    <img src="https://www.phptravels.net/themes/default/assets/img/android.png" alt="Image Alternative text" title="Image Title">
                    </i>
                    <span>Download on
                    <br>
...
<footer id="footer" class="footer-wrapper scrollspy-stopper ">
  <div class="container-fluid">
       ...
       <div class="col-12 col-lg-3 go-right">
            <h5 class="col-inner mt-15-sm footer-title go-text-right">
                <strong>
                        ...
                        <i class="material-icons">phone</i><!--Call Now--> +1-234-56789                    </span>
                                    </strong>
                <small>
                                <a href="/cdn-cgi/l/email-protection#51383f373e1125233027343d3036343f32287f323e3c"><span class="__cf_email__" data-cfemail="0e676068614e7a7c6f786b626f696b606d77206d6163">[email&#160;protected]</span></a>
                                </small>
            </h5>
            <div class="clear"></div>
            <ul class="footer-menu go-right go-text-right">
                <li><a href="javascript:void(0)" target="" title="" style="text-transform:uppercase;color: white; font-weight: bold;">Supplier</a></li>
                                <li><a target="_blank" href="https://www.phptravels.net/supplier-register/">Supplier Sign Up</a></li>
                                <li><a target="_blank" href="https://www.phptravels.net/supplier/">Supplier Login</a></li>
            </ul>
        </div>
                ...
                <div class="row gap-40 gap-md-20 row-reverse">
                    <div class="footer_menu col-12 col-md-6">
                            ...
                            <ul style="display: none;">
                                                                <li><a href="https://www.phptravels.net/contact-us" target=""
                                       title="">Contact</a></li>
                                                                <li><a href="https://www.phptravels.net/How-to-Book" target=""
                                       title="">How to Book</a></li>
                                                                <li><a href="https://www.phptravels.net/Booking-Tips" target=""
                                       title="">Booking Tips</a></li>
                                                                <li><a href="https://www.phptravels.net/About-Us" target=""
                                       title="">About Us</a></li>
                                                            </ul>
                        </li>
                            ...
                            <a>support</a>
                            <ul style="display: none;">
                                                                <li><a href="https://www.phptravels.net/FAQ" target=""
                                       title="">FAQ</a></li>
                                                                <li><a href="https://www.phptravels.net/Our-Partners" target=""
                                       title="">Our Partners</a></li>
                                                                <li><a href="https://www.phptravels.net/Privacy-Policy" target=""
                                       title="">Privacy Policy</a></li>
                                                                <li><a href="https://www.phptravels.net/Terms-of-Use" target=""
                        ...
                        <div class="clear"></div>
                            ...
                            <div class="footer-socials go-right">
                                                                <a target="_black" href="https://www.facebook.com/travelbusiness"><i class="fab fa-facebook"></i></a>
                                <!--<a href="https://www.facebook.com/travelbusiness" data-toggle="tooltip" data-placement="top" title="Facebook" target="_blank"><img src="https://www.phptravels.net/uploads/images/social/slufm6otpasooc.png" class="social-icons-footer sc-97mfds-11 hccXzw" /></a>-->
                                                                <a target="_black" href="https://twitter.com/phptravels"><i class="fab fa-twitter"></i></a>
                                <!--<a href="https://twitter.com/phptravels" data-toggle="tooltip" data-placement="top" title="Twitter" target="_blank"><img src="https://www.phptravels.net/uploads/images/social/9ztbr148kh4o8c8.png" class="social-icons-footer sc-97mfds-11 hccXzw" /></a>-->
                                                                <a target="_black" href="https:///www.youtube.com/phptravels"><i class="fab fa-youtube"></i></a>
                                <!--<a href="http:///www.youtube.com/phptravels" data-toggle="tooltip" data-placement="top" title="Youtube" target="_blank"><img src="https://www.phptravels.net/uploads/images/social/946746yt.png.png" class="social-icons-footer sc-97mfds-11 hccXzw" /></a>-->
                                                                <a target="_black" href="https://wa.me/13333334444"><i class="fab fa-whatsapp"></i></a>
                                <!--<a href="https://wa.me/13333334444" data-toggle="tooltip" data-placement="top" title="Whatsapp" target="_blank"><img src="https://www.phptravels.net/uploads/images/social/528076email.png.png" class="social-icons-footer sc-97mfds-11 hccXzw" /></a>-->
                                                                <a target="_black" href="https://www.google.com/maps/dir//phptravels+google+maps/data=!4m6!4m5!1m1!4e2!1m2!1m1!1s0x391905dd3eef0e45:0x25db87dacf506c66?sa=X&ved=2ahUKEwjn76Pn55DkAhWARhUIHVEvAEcQ9RcwGHoECA4QDg"><i class="fab fa-google-plus"></i></a>
                                <!--<a href="https://www.google.com/maps/dir//phptravels+google+maps/data=!4m6!4m5!1m1!4e2!1m2!1m1!1s0x391905dd3eef0e45:0x25db87dacf506c66?sa=X&ved=2ahUKEwjn76Pn55DkAhWARhUIHVEvAEcQ9RcwGHoECA4QDg" data-toggle="tooltip" data-placement="top" title="Google-plus" target="_blank"><img src="https://www.phptravels.net/uploads/images/social/2wz814aq9mgw04k.png" class="social-icons-footer sc-97mfds-11 hccXzw" /></a>-->
                                                                <a target="_black" href="https://www.instagram.com/phptravels_insta/"><i class="fab fa-instagram"></i></a>
                                <!--<a href="https://www.instagram.com/phptravels_insta/" data-toggle="tooltip" data-placement="top" title="Instagram" target="_blank"><img src="https://www.phptravels.net/uploads/images/social/729370rs.png.png" class="social-icons-footer sc-97mfds-11 hccXzw" /></a>-->
                                                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="container">
    <div class="text-center">Powered by <a href="http://www.phptravels.com" target="_blank"> <img src="https://www.phptravels.net/uploads/global/phptravels.png" style="height:22px;display: inline-block; -webkit-transform: translateY(6px);transform: translateY(6px);" height="22" alt="PHPTRAVELS" /> <strong>PHPTRAVELS</strong></a></div>
    </div>
    </div>
    <!-- ********************   Removing powered by linkback will result to cancellation of your support service.    ********************  -->
    </div>
    ...
    <div class="post-footer">
        <div class="container">
            <p class="footer-copy-right">&#169; All Rights Reserved by PHPTRAVELS</p>
        </div>
    </div>
    </footer>
    <!-- start Footer Wrapper -->
    ...
    <!-- jQuery -->
    <script data-cfasync="false" src="/cdn-cgi/scripts/5c5dd728/cloudflare-static/email-decode.min.js"></script><script src="https://www.phptravels.net/themes/default/assets/js/jquery-2.2.4.min.js"></script>
    <script>
    /* Ripple Effect */
    ...
    <script type="text/javascript" src="https://www.phptravels.net/themes/default/assets/js/plugins.js"></script>
    <script type="text/javascript" src="https://www.phptravels.net/themes/default/assets/js/custom-multiply-sticky.js"></script>
    <script type="text/javascript" src="https://www.phptravels.net/themes/default/assets/js/custom-core.js"></script>
        <script type="text/javascript" src="https://www.phptravels.net/themes/default/assets/js/scripts.js"></script>
    <!-- ###################################################################### -->
...
$('#location_from_code').val('{"code":"LHE","location":""}');
$('#location_to_code').val('{"code":"DXB","location":""}');
...
maximumSelectionSize: 1,
ajax: {
url: 'https://www.phptravels.net/cartrawler/getLocations',
dataType: 'json',
type: "GET",
quietMillis: 50,
data: function (term) {
...
minDate: new Date()
    ...
    <span id="cookieconsent:desc" class="cc-message">This website uses cookies to ensure you get the best experience on our website. <a aria-label="learn more about cookies" role="button" tabindex="0" class="cc-link" href="https://www.phptravels.net/cookies-policy" rel="noopener noreferrer nofollow" target="_blank">Learn more</a></span>
